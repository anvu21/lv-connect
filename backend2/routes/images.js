...
router.post('/profile/upload', upload.single('image'), async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query('INSERT INTO Users (username, password, group_id, created_at, updated_at,bio,profile_pic_url,user_type) VALUES ($1, $2, $3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, $4, $5, $6) RETURNING id', [username, hashedPassword, groupId, bio, image_url, user_type]);
